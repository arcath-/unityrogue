...
public class MyGame : RB.IRetroBlitGame
{
    ...
    public void Render()
    {
        ...
        RB.Print(
            ...
            "\nIf you enjoyed @ffffffRetroBlit@-, and would like to continue supporting its development then please share your feelings on @ffffffsocial media@-,\nand consider a review on the @ffffffUnity Asset Store@-!" +
            "\n\nThank you!");
    }
}
